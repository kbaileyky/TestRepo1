...
{
    public partial class TenantTestDelete : System.Web.UI.Page
    {
        Token t;
        ...
        protected void btnTest2_Click(object sender, EventArgs e)
        {
            try
            {
                Tenant.Delete("http://saturn.cs.trinity.edu:35357/", "not a token id", "cannot clean up new ten");
            }
            catch (Exception x)
            {
        ...
        protected void btnTest3_Click(object sender, EventArgs e)
        {
            try
            {
                Tenant.Delete("not a valid URL", t.token_id, "cannot clean up new ten");
            }
            catch (Exception x)
            {
        ...
        protected void btnTest4_Click(object sender, EventArgs e)
        {
            try
            {
                Tenant.Delete("http://saturn.cs.trinity.edu:35357/", t.token_id, "not a tenant id");
            }
            catch (Exception x)
            {
