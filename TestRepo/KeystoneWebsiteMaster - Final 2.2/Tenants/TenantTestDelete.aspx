...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <br />
    <section>
        <span class="auto-style1">public Tenant Tenant::Delete(string url, string UserToken, string tenantID)</span>
    </section>
    <br />
    <br />
            ...
            <div class="tab-pane active" id="1A">
                ...
                <section>
                    ...
                    <ul>
                        <li>Successful:  </li>
                        <ul>
                            <li>Deletes the requested Tenant</li>
                        </ul>
                ...
                <section>
                    ...
                    When passed valid arguments (url, UserToken, tenantID), the Tenant Get function shall execute a C# curl command to delete a tenant from the OpenStack Keystone Database service list on the designated URL server. The various message returns, specified above, will be explicitly returned as is applicable.
                </section>
            </div>
            ...
            <div class="tab-pane" id="1C">
               <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <h5>Test Case 1:</h5>
                        <p>Call Delete with valid parameters.<br />Tenant.Delete(&quot;http://cloud.cs.trinity.edu:35357/&quot;, t.token_id, tenant.tenantID)<br />
                            <asp:Button ID="btnTest1" runat="server" Text="Delete Tenant" OnClick="btnTest1_Click" />
                            <br />
                       ...
                       <h5>Test Case 2:</h5>
                       <p>Call Delete with invalid admin token.<br />Tenant.Delete(&quot;http://cloud.cs.trinity.edu:35357/&quot;, &quot;this is completely wrong&quot;, tenant.tenantID)<br />
                            <asp:Button ID="btnTest2" runat="server" Text="Delete Tenant" OnClick="btnTest2_Click" />
                            <br />
                       ...
                       <h5>Test Case 3:</h5>
                       <p>Call Delete with invalid url.<br />Tenant.Delete(&quot;this isn't even a URL???&quot;, t.token_id, tenant.tenantID)<br />
                            <asp:Button ID="btnTest3" runat="server" Text="Delete Tenant" OnClick="btnTest3_Click" />
                            <br />
                       ...
                       <h5>Test Case 4:</h5>
                       <p>Call Delete with invalid tenant id.<br />Tenant.Delete(&quot;http://cloud.cs.trinity.edu:35357/&quot;, t.token_id, &quot;not a tenant id&quot;)<br />
                            <asp:Button ID="btnTest4" runat="server" Text="Delete Tenant" OnClick="btnTest4_Click" />
                            <br />
