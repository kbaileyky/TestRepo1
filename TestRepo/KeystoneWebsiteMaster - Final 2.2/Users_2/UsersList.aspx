    ...
    <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1A">
                ...
                <p>Successful:<br />
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   A List of Users will be returned.<br />
                ...
                <p/>
                <p>When passed valid arguments (url, admin_token), the List User function shall 
        ...
        Output will be the list of created user after they are created.
        <br />
