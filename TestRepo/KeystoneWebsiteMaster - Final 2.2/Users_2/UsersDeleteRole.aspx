<%@ Page Title="Delete Role from User" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsersDeleteRole.aspx.cs" Inherits="KeystoneWebsite.Users.UsersDeleteRole" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <h1 style="margin-left:145px;">Delete Role from User</h1>
</asp:Content>
    ...
    <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1A">
                ...
                <p>Trinity Software Inc. will provide Rackspace with a function to Delete Roles from Users on the Keystone service.</p>
                <h4>Function Prototype</h4>
                <p>public static string DeleteRoleOfUser(string url, string UserId, string TenantId, string RoleId, string Admin_Token)</p>
                ...
                <p>url: the OpenStack server address<br />
                    ...
                    RoleId: the ID of the Role to be deleted from the User<br />
                    Admin_Token: the admin&#39;s Token ID<br />
                </p>
                <h4>Explicit Message Returns: (Fix This)</h4>
            ...
            <div class="tab-pane" id="1B">
                ...
                <ul>
                    ...
                    <li>Get User Roles List (May already contain Roles, but these will not be disturbed)</li>
                    <ul>
                        <b>Do 10 Times</b>
                        <li>Create Test Role</li>
                        <li>Add Test Role to User</li>
                        <li>Get List of User Roles (+1)</li>
                    </ul>
                    <ul>
                        <b>Do 10 Times</b>
                        <li>Remove Test Role From User</li>
                        <li>Remove Test Role</li>
                        <li>Get List of User Roles list (+1)</li>
                    </ul>
        ...
        <br />
                        ...
                        <section>
                            ...
                            <br />
                            <br />
                            Test 2 will attempt to run through the planned sequence but will have an incorrect admin token.
        ...
        <br />
                        ...
                        <section>
                            ...
                            <br />
                            <br />
                            Test 4 will attempt to run through the planned test sequence but will attempt to delete an non-exsistant Role.

        Output will be the message from the exception that is thrown. If the test and clean up are successful the button will turn blue and a label will appear next to it with the word "Pass". If the test fails
        the button will turn red and a label will appear next to the it with the word "FAIL". Keep in mind that passing the test will neither create nor delete roles.
        <br />
                            <br />
