    ...
    <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1A">
                ...
                <p>public static User Get(string url, string userID, string admin_token)</p>
                ...
                <p>On a successful return, this function will return a User with the designated userID 
                    by executing a C# HTTPWebRequest to the OpenStack Keystone service at the URL 
        ...
        Output will be the created User that is retrieved with the Get function.
        <br />
                            <br />
                            ...
                            <table style="width: 50%;">
                                <tr>
                                    <td class="auto-style1">
                                        ...
                                        <asp:ListBox ID="lstbxUser" runat="server" Height="200px" Width="425px" OnSelectedIndexChanged="lstbxUser_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox></td>
                                    <td class="auto-style2">
                                        <asp:Panel ID="pnlUserInfo" runat="server" Height="270px" ScrollBars="Auto" Width="568px">
