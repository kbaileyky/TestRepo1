            ...
            <div class="tab-pane active" id="1A">
                ...
                <p>
                   ...
                   Invalid User ID: "Exception of type 'Trinity.OpenStack.ObjectNotFound' was thrown."<br />
                    <p />
                <p>
                    When passed valid arguments (adminToken, userID, url), the Udate User
                            ...
                            <table style="width: 50%;">
                                <tr>
                                    <td class="auto-style1">
                                        ...
                                        <asp:ListBox ID="lstbxAfter" runat="server" Height="200px" Width="425px" AutoPostBack="True" OnSelectedIndexChanged="lstbxAfter_SelectedIndexChanged"></asp:ListBox></td>
                                    <td class="auto-style2">
                                        <asp:Panel ID="pnlAfterEpInfo" runat="server" Height="270px" ScrollBars="Auto" Width="568px">
