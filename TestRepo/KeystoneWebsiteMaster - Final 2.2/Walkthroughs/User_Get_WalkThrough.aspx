...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" BorderColor="#323232" BorderStyle="Solid" BorderWidth="5px" 
            ...
            <asp:Button ID="btnNext1" runat="server" onclick="btnNext1_Click" 
                ...
                Text="Next" />           
            <asp:Label ID="lblErrorPrototype" runat="server" 
                style="z-index: 1; left: 6px; top: 81px; position: absolute" 
                Text="Get Error Prototype:" Font-Underline="True"></asp:Label>
            <asp:TextBox ID="txtErrorPrototype" runat="server" 
                style="z-index: 1; left: 167px; top: 82px; position: absolute; width: 969px">public static string GetUserById_Error(string url, string AdminID, string UserId)
</asp:TextBox>
        </asp:Panel>
