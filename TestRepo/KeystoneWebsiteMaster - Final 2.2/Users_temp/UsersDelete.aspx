    ...
    <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1A">
                ...
                <p>public static string Delete(string url, string userID, string admin_token)</p>
            ...
            <div class="tab-pane" id="1B">
                ...
                <ol>
                    ...
                    <li>Call an unsuccessful Add with an invalid userID.</li>
                    <li>Call the List function to show all Users again</li>
