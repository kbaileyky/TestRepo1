<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="ServiceList.aspx.cs" Inherits="KeystoneWebsite.ServiceList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <h1 style="margin-left:145px;">List Services</h1>
</asp:Content>
    ...
    <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1A">
                ...
                <p>Trinity Computer Science Inc. will provide Intel Inc. with a function to List all Services in the Keystone Database</p>
                <h4>Function Prototype</h4>
                <p> Object <-- List (string URL, string AdminToken)</p>
                ...
                <p>Successful: &nbsp;&nbsp;&nbsp;&nbsp;"Object returned when successful"<br />
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   "Error #2 <-- The AdminToken is invalid"
                <p/>
            ...
            <div class="tab-pane" id="1C">
                ...
                <asp:RadioButtonList ID="RadioButtonList1" CssClass="radioWithProperWrap" runat="server">
                    <asp:ListItem selected="True" Value="1">Case 1: Calling List with valid URL and AdminToken arguments</asp:ListItem>
                    <asp:ListItem Value="2">Case 2: Calling List with an invalid AdminToken</asp:ListItem>
                    <asp:ListItem Value="3">Case 3: Calling List with invalid server URL</asp:ListItem>
                </asp:RadioButtonList>
                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnServiceListTest" runat="server" Text="Submit" OnClick="btnServiceListTest_Click"/>
                        <br />
                        <h4>Test results:</h4>
