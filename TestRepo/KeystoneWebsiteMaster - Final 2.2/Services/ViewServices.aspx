<%@ Page Language="C#" Title="View Services" AutoEventWireup="true" CodeBehind="ViewServices.aspx.cs" Inherits="KeystoneWebsite.Services.ViewServices" MasterPageFile ="~/Site.Master" %>
...
<br />
    <section>
        <asp:Button ID="btnListEndpoints" runat="server" Height="52px" Text="Get Services" Width="182px"/>
    </section> 
    
     <table style="width:50%;">
         <tr>
             <td class="auto-style1"> <asp:ListBox ID="lstbxEndpoints" runat="server" Height="240px" Width="572px" AutoPostBack="True"></asp:ListBox></td>
             <td class="auto-style2">
                 <asp:Panel ID="pnlEndpointInfo" runat="server" Height="270px" ScrollBars="Auto" Width="568px" Visible="False">
                     <asp:Label ID="lblEndpoint" runat="server" Text="Tenant:"></asp:Label>
                     <br />
                     <table style="width:100%;">
                         <tr>
