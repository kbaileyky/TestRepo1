        ...
        <div class="tab-content">
            <div class="tab-pane active" id="1A">
                ...
                <ul>
                    <li>Successful:
                <ul>
                    <li>Void. The Role will be have been deleted from the KeyStone database.</li>
                </ul>
                    </li>
                    ...
                    <li>&nbsp;<ul>
                        ...
                        <li>Error Role Assigned to User: </li>
                    </ul>
                    </li>
                </ul>
                <h4>Description</h4>
            ...
            <div id="1B" class="tab-pane">
                <section>
                    ...
                    <ul>
                        ...
                        <li>Test Preparation:
                        <ul>
                            <li>Add a Role with name "TestRole1"</li>
                            <li>Display List of Roles to verify it was added</li>
                        </ul>
                            <li>Test 1:
                        <ul>
                            <li>Call Delete with correct parameters</li>
                            <li>Display List of Roles to verify it was deleted</li>
                        </ul>
                            </li>
                        <li>Test 2:<ul>
                            <li>Call Delete with an invalid URL</li>
                            <li>Display error message: &quot;The operation has timed out.&quot;</li>
                        </ul>
                        </li>
                        <li>Test 3:<ul>
                            <li>Call Delete with an invalid role_id</li>
                            <li>Display error message:&quot;Exception of type &#39;Trinity.OpenStack.ObjectNotFound&#39; was thrown.&quot;</li>
                        </ul>
                        </li>
                        <li>Test 4:<ul>
                            <li>Call Delete with invalid admin_token</li>
                            <li>Display error message: &quot;Exception of type &#39;Trinity.OpenStack.Unauthorized&#39; was thrown.</li>
                        </ul>
                        </li>
                        <li>Test 4:<ul>
                            <li>Call Delete on a Role that belongs to a User</li>
                ...
                <section>
                    ...
                    <blockquote class="pullquote">
                        curl -H -X DELETE &quot;X-Auth-Token:_token_id_&quot; http://sampleserveraddress:35357/v2.0/OS-KSADM/roles/_role_id_
                    </blockquote>
                </section>
            </div>
            <div id="1C" class="tab-pane">
                ...
                <asp:TextBox ID="txtAdminUrl" runat="server"></asp:TextBox>
                        ...
                        <h5>Test Case 1:</h5>
                        <p>
                            Call Delete with valid parameters.<br />
                            <asp:Button ID="btnTest1" runat="server" Text="Delete Role" OnClick="btnTest1_Click" />
                            <br />
                        ...
                        <h5>Test Case 2:</h5>
                        <p>
                            Call Delete with an invalid URL.<br />
                            <asp:Button ID="btnTest2" runat="server" Text="Delete Role" OnClick="btnTest2_Click" />
                            <br />
                        ...
                        <h5>Test Case 3:</h5>
                        <p>
                            Call Delete with an invalid RoleID.<br />
                            <asp:Button ID="btnTest3" runat="server" Text="Delete Role" OnClick="btnTest3_Click" />
                            <br />
                        ...
                        <h5>Test Case 4:</h5>
                        <p>
                            Call Delete with an invalid Admin Token.<br />
                            <asp:Button ID="btnTest4" runat="server" Text="Delete Role" OnClick="btnTest4_Click" />
                            <br />
                        ...
                        <h5>Test Case 5:</h5>
                        <p>
                            Call Delete on a Role that has been assigned to a User.<br />
                            <asp:Button ID="btnTest5" runat="server" Text="Delete Role" OnClick="btnTest5_Click" />
                            <br />
